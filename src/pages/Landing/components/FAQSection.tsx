...
const faqData: FAQItemProps[] = [
    {
        ...
        answer: "Конечно! Мы ценим вашу заинтересованность и понимаем желание приобрести достойный продукт, благодаря чему у вас будет возможность протестировать желаемый вездеход перед покупкои и убедиться в его качестве."
    },
    {
    ...
    },
    {
        ...
        answer: "Для своих клиентов мы можем оказать услуги по доставке заказанных вездеходов различными видами транспорта, выстроив оптимальную схему перевозки техники до нужного места, максимально выгодную и удобную для вас. Самыми популярными и востребованными способами доставки вездеходов являются: автомобильная (на трале), железнодорожная (на ж/д платформе), морская. Подробности вы можете прочитать в разделе «Доставка»"
    },
    {
